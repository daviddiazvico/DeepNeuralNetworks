...
save(strcat(currentPath, '/experiments/PCP1.', num2str(M), 'test.mat'),
     'testdata', 'testlabels', 'predictedtargets', 'predictedlabels', 'error');
error
...
for l = 1:nlayers
    ...
    save(strcat(currentPath, '/experiments/MLP', num2str(l), '.', ...
         num2str(M), 'test.mat'), 'testdata', 'testlabels', ...
         'predictedtargets', 'predictedlabels', 'error');
    errorMLP(l) = error;

    % Visualizes the propagation
    visualizePropagation(12*(l - 1) + 1, model.W, testdata, activations, ...
                         strcat(strcat('PropagationMLP', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 2, model.W, testdata, activations, ...
                         strcat(strcat('PropagationAMLP', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 3, model.W, testdata, activations, ...
                         strcat(strcat('PropagationAE', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 4, model.W, testdata, activations, ...
                         strcat(strcat('PropagationAEWFT', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 5, model.W, testdata, activations, ...
                         strcat(strcat('PropagationDAE', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    save(strcat(currentPath, '/experiments/DAE', num2str(l), '.', ...
         num2str(M), 'WFTtest.mat'), 'testdata', 'testlabels', ...
         'predictedtargets', 'predictedlabels', 'error');
    errorDAEWFT(l) = error;

    % Visualizes the propagation
    visualizePropagation(12*(l - 1) + 6, model.W, testdata, activations, ...
                         strcat(strcat('PropagationDAEWFT', num2str(l), ...
                         '.', num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 7, model.W, testdata, activations, ...
                         strcat(strcat('PropagationSAE', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    % Visualizes the propagation
    visualizePropagation(12*(l - 1) + 8, model.W, testdata, ...
                         activations, strcat(strcat('PropagationSAEWFT', ...
                         num2str(l), '.', num2str(M))), strcat(currentPath, ...
                         '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 9, model.W, testdata, activations, ...
                         strcat(strcat('PropagationSDAE', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 10, model.W, testdata, activations, ...
                         strcat(strcat('PropagationSDAEWFT', num2str(l), ...
                         '.', num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 11, model.W, testdata, activations, ...
                         strcat(strcat('PropagationDBN', num2str(l), '.', ...
                         num2str(M))), strcat(currentPath, '/experiments'))
    ...
    visualizePropagation(12*(l - 1) + 12, model.W, testdata, activations, ...
                         strcat(strcat('PropagationDBNWFT', num2str(l), ...
                         '.', num2str(M))), strcat(currentPath, '/experiments'))
...
%plot(Larray, errorMLP, Larray, errorAMLP, Larray, errorAE, '-', Larray, ...
%     errorDAE, '-', Larray, errorSAE, '-', Larray, errorSDAE, '-', Larray, ...
%     errorRBM, '-', Larray, errorAEWFT, '--', Larray, errorDAEWFT, '--', ...
%     Larray, errorSAEWFT, '--', Larray, errorSDAEWFT, '--', Larray, ...
%     errorRBMWFT, '--');
plot(Larray, errorMLP, 'k^-', Larray, errorAMLP, 'ko-', Larray, errorAE, ...
     'r^-', Larray, errorDAE, 'g^-', Larray, errorSAE, 'b^-', Larray, ...
     errorSDAE, 'y^-', Larray, errorRBM, 'm^-', Larray, errorAEWFT, 'ro-', ...
     Larray, errorDAEWFT, 'go-', Larray, errorSAEWFT, 'bo-', Larray, ...
     errorSDAEWFT, 'yo-', Larray, errorRBMWFT, 'mo-');
legend('MLP', 'AMLP', 'AE', 'DAE', 'SAE', 'SDAE', 'RBM', 'AEWFT', 'DAEWFT', ...
       'SAEWFT', 'SDAEWFT', 'RBMWFT');
